                    ...
                    <div class="product-item">
                        <div class="product-img">
                            <a href="single-product.html?id=${product.id}">
                                <img class="primary-img" src="http://159.223.67.62:1339${productProps.images.data[0].attributes.url}" alt="Product Images">
                                <img class="secondary-img" src="http://159.223.67.62:1339${productProps.images.data[1].attributes.url}" alt="Product Images">
                            </a>
